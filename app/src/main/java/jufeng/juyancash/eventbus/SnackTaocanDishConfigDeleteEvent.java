...
public class SnackTaocanDishConfigDeleteEvent {
    private OrderDishEntity mOrderDishEntity;
    private OrderTaocanGroupDishEntity mOrderTaocanGroupDishEntity;

    public SnackTaocanDishConfigDeleteEvent(OrderDishEntity orderDishEntity, OrderTaocanGroupDishEntity orderTaocanGroupDishEntity) {
