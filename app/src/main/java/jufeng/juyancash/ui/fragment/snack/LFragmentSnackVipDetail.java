 ...
 */
public class LFragmentSnackVipDetail extends BaseFragment {
    private TextView tvCancle, tvConfirm,tvName,tvVipType,tvVipRate,tvVipNo,tvChangeVip;
    private String orderId;
    private RadioGroup mRadioGroup;

    public static LFragmentSnackVipDetail newInstance(String orderId){
        LFragmentSnackVipDetail fragment = new LFragmentSnackVipDetail();
                    ...
                    switch (mRadioGroup.getCheckedRadioButtonId()){
                        case R.id.radio_0://使用会员卡优惠
                            ...
                            if(discountHistoryEntity != null || isWithCoupon){//当前已使用优惠券或会员卡优惠
                                ...
                                EventBus.getDefault().post(new SnackVipDetailConfirmEvent(orderId));
                            }
                            break;
        ...
        tvChangeVip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isHasVipPay){
                    ...
                    EventBus.getDefault().post(new SnackVipChangeEvent());
                }
            }
        });
    }
