 ...
 */
public class LFragmentSchedulePerfect extends BaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        mainActivity.setSchedulePerfectHandler(mHandler);
    }
    ...
    private void setAdapter() {
        adapter = new ScheduleHistoryAdapter(getActivity(), 3);
