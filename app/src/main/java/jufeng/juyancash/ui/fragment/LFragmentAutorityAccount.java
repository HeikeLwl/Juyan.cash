...
public class LFragmentAutorityAccount extends BaseFragment {
    private EditText etAccount, etPWD;
    private Button btnConfirm;
    private OnAuthorityAccountListener mOnAuthorityAccountListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.fragment_authority_account, container, false);
        initView(mView);
        setListener();
        return mView;
    }
    ...
    private void setListener() {
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnAuthorityAccountListener != null && !employeeName.isEmpty() && !employeePwd.isEmpty()) {
                    ...
                    if (employeeEntity != null) {
                        mOnAuthorityAccountListener.onAccountAuthorityClick(employeeEntity);
                    } else {
    ...
    public void setOnAuthorityAccountListener(OnAuthorityAccountListener listener) {
        mOnAuthorityAccountListener = listener;
    }

    public interface OnAuthorityAccountListener {
        void onAccountAuthorityClick(EmployeeEntity employeeEntity);
    }
}
