 ...
 */
public class LFragmentSnackSearchDish extends BaseFragment {
    ...
    public static LFragmentSnackSearchDish newInstance(String orderId){
        LFragmentSnackSearchDish fragment = new LFragmentSnackSearchDish();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.fragment_snack_search_dish, container, false);
        initView(mView);
        setRightAdapter();
        setListener();
        return mView;
...
//                EventBus.getDefault().post(new SearchDishUpdateEvent(matchStr, type, mOrderId));
        ...
        rightAdapter.setOnSearchDishClickListener(new SearchDishAdapter.OnSearchDishClickListener() {
            ...
            public void onTaocanClick(TaocanEntity taocanEntity) {
                EventBus.getDefault().post(new SnackTaocanClickEvent(taocanEntity,taocanEntity.getTaocanTypeId()));
            }
