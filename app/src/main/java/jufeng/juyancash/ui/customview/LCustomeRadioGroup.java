 ...
 */
public class LCustomeRadioGroup extends LinearLayout {
    ...
    public LCustomeRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public LCustomeRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onFinishInflate() {
        ...
        if (mCheckedId != -1) {
            ...
            setCheckedId(mCheckedId,mBundle);
        }
    }
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioButton) {
            ...
            if (button.isChecked()) {
                ...
                mProtectFromCheckedChange = false;
                setCheckedId(button.getId(),mBundle);
            }
     ...
     * @see #clearCheck()
     */
    public void check(int id,Bundle bundle) {
        this.mBundle = bundle;
        // don't even bother
    ...
    private void setCheckedId(int id,Bundle bundle) {
        mCheckedId = id;
        if (mOnCheckedChangeListener != null) {
            Log.d("###", "选择："+mCheckedId+","+bundle);
            mOnCheckedChangeListener.onCheckedChanged(this, mCheckedId,bundle);
        }else{
        }
    }
    ...
    public void clearCheck(Bundle bundle) {
        check(-1,bundle);
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new LCustomeRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof LCustomeRadioGroup.LayoutParams;
    }
    ...
    /**
     * <p>
     * Interface definition four a callback to be invoked when the checked radio
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(LCustomeRadioGroup group, int checkedId, Bundle bundle);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == LCustomeRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == LCustomeRadioGroup.this
