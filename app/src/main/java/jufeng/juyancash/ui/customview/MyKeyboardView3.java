...
public class MyKeyboardView3 extends KeyboardView {

    private Context context;

    public MyKeyboardView3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        for(Keyboard.Key key: keys) {
            if(key.label != null) {
                ...
                }else if(key.label.equals("AC") || key.label.equals("删除") ){
