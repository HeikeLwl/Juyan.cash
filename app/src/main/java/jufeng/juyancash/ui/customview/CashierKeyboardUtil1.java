...
public class CashierKeyboardUtil1 {
    ...
    private Context ctx;
    private MyKeyboardView2 keyboardView;
    private Keyboard k1;// 收银键盘
    private EditText ed;
    private OnCashierKeyBoardClickListener mOnCashierKeyBoardClickListener;

    public CashierKeyboardUtil1(Context ctx, View view, EditText edit) {
        this.ctx = ctx;
        this.ed = edit;
        k1 = new Keyboard(ctx, R.xml.cashier1);
        keyboardView = (MyKeyboardView2) view.findViewById(R.id.keyboard_view);
