...
package jufeng.juyancash.materialdaterangepicker.date;
...
import jufeng.juyancash.materialdaterangepicker.HapticFeedbackController;
import jufeng.juyancash.materialdaterangepicker.TypefaceHelper;
import jufeng.juyancash.materialdaterangepicker.Utils;
...
//        mDayOfWeekView = (TextView) view.findViewById(R.id.date_picker_day);
        ...
        mAccentColor = ContextCompat.getColor(getActivity(), R.color.mdtp_accent_color);
        if (mAccentColor == -1) {
