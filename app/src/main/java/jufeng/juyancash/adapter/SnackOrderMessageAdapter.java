 ...
 */
public class SnackOrderMessageAdapter extends RecyclerView.Adapter<SnackOrderMessageAdapter.ViewHolder> {
    private Context mContext;
    private ArrayList<WxOrderMessageEntity> mWxOrderMessages;

    public SnackOrderMessageAdapter(Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.wx_snack_order_message_item_layout, parent,false);
