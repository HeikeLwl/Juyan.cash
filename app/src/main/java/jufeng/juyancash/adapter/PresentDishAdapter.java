 ...
 */
public class PresentDishAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PresentDishAdapter(Context context, String orderId, boolean isOpenJoinOrder) {
        ...
        datas = new ArrayList<>();
        //子单
        datas.addAll(DBHelper.getInstance(mContext.getApplicationContext()).queryPresentableOrderDish(orderId));
    ...
    public void updateData(String orderId, boolean isOpenJoinOrder) {
        ...
        checkDishMap.clear();
        datas.clear();
        datas.addAll(DBHelper.getInstance(mContext).queryPresentableOrderDish(orderId));
    ...
    class ViewHolder0 extends RecyclerView.ViewHolder {
        private TextView tvName, tvExtras, tvCount, tvPrice;
