 ...
 */
public class SnackEditDishAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SnackEditDishAdapter(Context context, String orderId, int type) {
    ...
    public void updateData(String orderId, int type) {
        retreatDishes.clear();
        this.orderId = orderId;
        this.mType = type;
        allDishMap.clear();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.retreat_dish_item_layout, parent, false);
