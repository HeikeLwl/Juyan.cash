 ...
 */
public class PrintCashierCollectionRunnable implements PrintBean {
    ...
    public PrintCashierCollectionRunnable(Context context, String cashierName, String isShift, String payModeName, int dateType, String areaTypeName,Map<String,String> orderMoneyDetail, ArrayList<PayModeEntity> payModeEntities) {
    ...
    public void printData(){
        ...
        printer.PrintEnter();
        printer.PrintText(CustomMethod.getPrintStr("员工账单汇总",2,48),0,3,0);
        printer.PrintEnter();
