 ...
 */
public class PrintXiaofeiDilianRunnable implements PrintBean {
    ...
    public PrintXiaofeiDilianRunnable(Context context, ArrayList<PrintDishBean> printDishBeenes, String orderId, String ip) {
    ...
    private void printData(){
        ...
        if(mStoreVersion == 0){
            ...
            printer.PrintEnter();
            printer.PrintText(CustomMethod.getPrintStr("单号："+mOrderEntity.getOrderNumber1(),"单位：元",1,48), 2, 0, 0);
        }else if(mStoreVersion == 2){
            printer.PrintText(areaName+tableCode, 0, 3, 0);
            printer.PrintEnter();
            printer.PrintText("流水号："+serailNumber, 0, 0, 0);
        ...
        for (PrintDishBean printDishBean :
            ...
            printer.PrintText(CustomMethod.getPrintStr(28,20,String.valueOf(printDishBean.getDishPrice())),0,0,0);
            printer.PrintEnter();
        }
        printer.PrintText("------------------------------------------------",0,0,0);
        printer.PrintEnter();
