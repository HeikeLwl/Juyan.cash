 ...
 */
public class PrintTurnOverOrderRunnable implements PrintBean {
    private NetPrinter printer;
    private Context mContext;
    private int mDateType;
    private String cashierName,turnOverTime,areaTypeName;
    private ArrayList<DishTypeCollectionItemBean>dishTypeCollectionItemBeens;
    private ArrayList<PayModeEntity> mPayModeEntities;
    private Map<String,String> mOrderMoneyDetail;
    public PrintTurnOverOrderRunnable(Context context, String turnOverTime, String cashierName, int dateType, String areaTypeName, ArrayList<PayModeEntity> payModeEntities, ArrayList<DishTypeCollectionItemBean> dishTypeCollectionItemBeens, Map<String,String> mOrderMoneyDetail) {
        this.mContext = context;
        this.mDateType = dateType;
        this.turnOverTime = turnOverTime;
        this.cashierName = cashierName;
        this.areaTypeName = areaTypeName;
        this.dishTypeCollectionItemBeens = dishTypeCollectionItemBeens;
        this.mPayModeEntities = payModeEntities;
        this.mOrderMoneyDetail = mOrderMoneyDetail;
    }
    ...
    public void printData(){
        ...
        printer.PrintEnter();
        printer.PrintText(CustomMethod.getPrintStr("交接班",2,48),0,3,0);
        printer.PrintEnter();
        ...
        printer.PrintText(CustomMethod.getPrintStr("账单总数",mOrderMoneyDetail.get("totalCount"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("已结账账单总数",mOrderMoneyDetail.get("cashieredCount"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("已结账账单金额",mOrderMoneyDetail.get("cashieredMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("未结账账单总数",mOrderMoneyDetail.get("unCashieredCount"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("未结账账单金额",mOrderMoneyDetail.get("unCashieredMoney"),1,48),0,0,0);
        printer.PrintText("------------------------------------------------" ,0,0,0);
        ...
        printer.PrintText("------------------------------------------------" ,0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("消费合计",mOrderMoneyDetail.get("receivableMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("付款合计",mOrderMoneyDetail.get("incomeMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("赠菜合计",mOrderMoneyDetail.get("presentMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("抹零合计",mOrderMoneyDetail.get("mlMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("折扣合计",mOrderMoneyDetail.get("discountMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("不吉利尾数合计",mOrderMoneyDetail.get("bjlMoney"),1,48),0,0,0);
        printer.PrintText(CustomMethod.getPrintStr("优惠券合计",mOrderMoneyDetail.get("couponMoney"),1,48),0,0,0);
        printer.PrintText("------------------------------------------------" ,0,0,0);
        printer.PrintEnter();
