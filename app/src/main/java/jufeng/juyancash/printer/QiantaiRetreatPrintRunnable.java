 ...
 */
public class QiantaiRetreatPrintRunnable implements PrintBean {
    ...
    public QiantaiRetreatPrintRunnable(Context context, ArrayList<PrintDishBean> printDishBeenes, String orderId, String ip, String employeeName, String reason) {
        initData(context,printDishBeenes,orderId,ip,employeeName,reason);
    }

    private void initData(Context context, ArrayList<PrintDishBean> printDishBeenes, String orderId,String ip, String employeeName,String reason){
