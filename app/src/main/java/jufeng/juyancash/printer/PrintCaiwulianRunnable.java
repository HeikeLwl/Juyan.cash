 ...
 */
public class PrintCaiwulianRunnable implements PrintBean {
    ...
    public PrintCaiwulianRunnable(Context context, String orderId, String ip,boolean isPrintPresentDish,boolean isPrintRetreatDish) {
    ...
    public void printData(){
        ...
        String tableCode = DBHelper.getInstance(mContext).getTableNameByTableId(orderEntity.getTableId());
        ...
        double incomeMoney = DBHelper.getInstance(mContext).getHadPayMoneyByOrderId(mOrderId);
        ...
        printer.PrintEnter();
        printer.PrintText(CustomMethod.getPrintStr("结账单(财务联)",2,48),0,3,0);
        printer.PrintEnter();
