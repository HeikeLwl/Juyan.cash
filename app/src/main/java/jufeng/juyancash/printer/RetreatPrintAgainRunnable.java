 ...
 */
public class RetreatPrintAgainRunnable implements PrintBean {
    ...
    public RetreatPrintAgainRunnable(Context context, PrinterFailedHistoryEntity printerFailedHistoryEntity, String[] printDishBeenes, String orderId, PrintKitchenEntity printKitchenEntity, String employeeName, String reason) {
        initData(context, printerFailedHistoryEntity, printDishBeenes, orderId, printKitchenEntity, employeeName, reason);
    }

    private void initData(Context context, PrinterFailedHistoryEntity printerFailedHistoryEntity, String[] printDishBeenes, String orderId, PrintKitchenEntity printKitchenEntity, String employeeName, String reason) {
