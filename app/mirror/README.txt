...
If you do not use any flavor, build dishTypeModelType or variant specific sourcesets,
...
Gradle/Android Studio (from the most specific to the least specific):
               ...
               variant > build dishTypeModelType > flavor > main
...
Here's a more generalized directory structure:
    ...
    mirror/
        ...
        <build dishTypeModelType specific directories>
